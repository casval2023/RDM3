...
data = {
    ...
    "問12": {
        "question": "A～Cの言葉を下記の語群から選び、文章を完成させましょう。(　A　）は肝臓の中に中性脂肪が溜まりすぎることを言い、自覚症状があまりなく食事や運動による療法で跡形もなく治癒しますが放っておくと慢性的な（　B　）障害を引き起こすことがあり、とくに糖尿病があるときには（　C　）から肝臓へ中性脂肪が送られるようになるので要注意です。",
